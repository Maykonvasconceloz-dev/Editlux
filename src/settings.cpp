...
static const QString SHOTCUT_INI_FILENAME("/editlux.ini");
...
{
    QString language = settings.value("language", "pt_BR").toString();
    if (language == "en")
        language = "en_US";
    return language;
}
...
{
    return settings.value("player/profile", "atsc_1080p_30").toString();
}
