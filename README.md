...
Editlux é um editor de vídeo nativo e offline para Linux, derivado do Shotcut sob
a licença GPLv3. Esta árvore mantém os avisos de direitos autorais e a documentação
do projeto original. Consulte [EDITLUX.md](EDITLUX.md) para conhecer as alterações,
compilar e gerar os pacotes Linux.

Editlux é um projeto independente. Não é afiliado ao CapCut nem à ByteDance e não
inclui código, ícones ou outros recursos proprietários desses produtos.
